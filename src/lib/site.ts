...
export const privacySections = {
  it: [
    ...
    ["2. Tipologie di dati trattati", "Trattiamo dati identificativi e di contatto, dati contenuti nelle comunicazioni, dati contrattuali e di pagamento, dati tecnici di navigazione e, per la verifica telefonica degli ordini e l’accesso all’Area Clienti, numero di cellulare ed esito dei codici OTP inviati via SMS. Nel modulo Contatti utilizziamo inoltre Google reCAPTCHA, che riceve il tuo indirizzo IP e dati sul comportamento di navigazione per calcolare un punteggio antispam. La chat del sito (tawk.to) tratta il contenuto delle conversazioni e dati tecnici di navigazione per fornire assistenza in tempo reale."],
    ["3. Finalità e basi giuridiche", "I dati sono trattati per rispondere alle richieste e adottare misure precontrattuali, anche tramite la chat del sito; eseguire contratti e fornire i servizi; adempiere obblighi legali, fiscali e contabili; tutelare diritti e prevenire abusi, incluso l’uso di Google reCAPTCHA nel modulo Contatti, in base al legittimo interesse; inviare comunicazioni promozionali e usare cookie non necessari esclusivamente previo consenso."],
    ...
    ["9. Aggiornamenti e processo decisionale", "Non utilizziamo processi decisionali esclusivamente automatizzati che producano effetti giuridici. La presente informativa può essere aggiornata; la data dell’ultima revisione è 24 settembre 2026."],
  ],
  en: [
    ...
    ["5. Recipients and transfers", "Data may be disclosed to authorised staff, advisers and the suppliers that make the service possible: hosting and database (Supabase), online payment processors (Stripe, PayPal, SumUp), SMS delivery for phone verification (Twilio and/or Aruba), email delivery, Google reCAPTCHA for protection against automated traffic, tawk.to for the site's chat and, only if authorised via the cookie banner, Google Tag Manager for analytics; all appointed as processors where required. Data is disclosed to competent authorities when legally required. Stripe, PayPal, Twilio, Google and tawk.to are also based outside the European Economic Area and may process data elsewhere: the transfer relies on the safeguards adopted by each supplier, such as the EU-U.S. Data Privacy Framework or the European Commission's Standard Contractual Clauses."],
    ...
    ["9. Updates and automated decisions", "We do not use solely automated decisions producing legal effects. This notice may be updated; last revised 24 September 2026."],
  ],
};
