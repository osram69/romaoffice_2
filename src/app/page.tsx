...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Roma Office Sharing", description: "Uffici e domiciliazione nel cuore di Roma.", url: BASE_URL, siteName: "Roma Office Sharing", locale: "it_IT", type: "website", images: [{url:"/images/office-hero-og.jpg",width:1200,height:630}] },
  twitter: { card: "summary_large_image", title: "Roma Office Sharing", description: "Uffici e domiciliazione nel cuore di Roma.", images: ["/images/office-hero-og.jpg"] },
};
