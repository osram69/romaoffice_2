...
export default async function RootLayout({ children }: { children: ReactNode }) {
  ...
  if (pathname.startsWith("/gestione-tariffe-x9k2m7") || pathname.startsWith("/gestione-domiciliazioni-x9k2m7") || pathname.startsWith("/gestione-ordini-x9k2m7")) return <html lang="it"><body>{children}</body></html>;
