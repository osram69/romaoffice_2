...
export function CookiePolicyContent({ lang }: { lang: Lang }) {
  ...
  return <>
    ...
    <p>{it ? "I cookie sono piccoli file memorizzati dal browser. Questo sito usa cookie tecnici necessari e, con consenso, categorie analitiche e di marketing." : "Cookies are small files stored by your browser. This site uses necessary technical cookies and, with consent, analytics and marketing categories."}</p>
